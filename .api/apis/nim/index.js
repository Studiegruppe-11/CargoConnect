...
class SDK {
    constructor() {
        ...
        this.core = new APICore(this.spec, 'nim/24.03 (api/6.1.2)');
    }
    /**
     ...
     */
    nvidiaCuoptInfer(body, metadata) {
        return this.core.fetch('/nvidia/cuopt', 'post', body, metadata);
    }
    /**
     ...
     */
    nvidiaCuoptStatuspolling(metadata) {
